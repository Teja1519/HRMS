...
const newJoiners = [
  { name: "Emily Chen", position: "Software Engineer", department: "Engineering", date: "Jun 1, 2026" },
  { name: "Robert Lee", position: "Marketing Manager", department: "Marketing", date: "Jun 3, 2026" },
  { name: "Lisa Anderson", position: "Sales Executive", department: "Sales", date: "Jun 5, 2026" },
];
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-3xl font-bold mt-2">502</h3>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-3xl font-bold mt-2">492</h3>
                <div className="flex items-center gap-1 mt-2">
                  <TrendingUp className="w-4 h-4 text-success" />
                  <span className="text-sm text-success">98.0%</span>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center gap-1 mt-2">
                  <span className="text-sm text-muted-foreground">Across 3 locations</span>
                </div>
              </div>
