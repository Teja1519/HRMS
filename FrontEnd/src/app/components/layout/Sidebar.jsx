...
const menuItems = [
  ...
  { icon: User, label: "My Profile", path: "/profile", roles: ["Admin", "HR", "Employee"] },
  ...
  return (
    <aside className="w-64 bg-card border-r border-border h-screen flex flex-col">
      ...
      <div className="p-4 border-t border-border flex items-center justify-between">
        <div
          className="flex items-center gap-3 px-2 min-w-0 flex-1 cursor-pointer hover:opacity-80 transition-opacity"
